      ...
      <div className="flex h-[120px]">
        ...
        <div className="flex flex-col justify-between basis-auto ml-2">
          <div>
            ...
            <p className="text-label_m mb-2">Name: 윤창진</p>
          </div>
          <Badge className="text-title_s">
            Change Avatar
          </Badge>
        </div>
      </div>

      <div className="grid p-2 mt-2 border rounded-sm border-border-div">
        <div className="flex p-1">
          <div className="basis-1/2">
            <p className="text-subhead_s">2,334</p>
            <p className="text-title_m text-text-secondary">팔로잉</p>
          </div>
          <div className="basis-1/2">
            <p className="text-subhead_s">15</p>
            <p className="text-title_m text-text-secondary">팔로워</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex justify-between p-1">
          <div className="flex">
            <Image
              ...
              alt={"eth"}
            />
            <h4 className="text-title_m"> CAZ 토큰</h4>
          </div>
          <h5 className="text-title_m">1,000.02</h5>
        </div>
      </div>
    </Card>
  );
