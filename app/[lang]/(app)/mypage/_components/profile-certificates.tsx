...
import { AchievementReward, NFT_TYPE, SBT_TYPE } from "@/lib/interfaces";
...
export default function ProfileCertificates({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {achievement_rewards &&
        achievement_rewards.map(
          (achievement_reward: AchievementReward, index: number) => {
            if (
              achievement_reward.status == "granted" &&
              achievement_reward.achievement.nft_type == NFT_TYPE.SBT && 
              achievement_reward.achievement.type == SBT_TYPE.EDU
            ) {
              return (
                <Dialog key={index}>
                  <DialogTrigger>
                    <NftCard
                      id={achievement_reward.id}
                  ...
                  <DialogPortal>
                    ...
                    <DisplayNFTModal
                      details={achievement_reward.achievement}
