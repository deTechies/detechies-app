...
const criteria: Criterion[] = [
  { id: '1', name: "원칙 vs 융통성", ranks: 5, minText: "원칙", maxText: "융통성", category: "일반적인 성향" },
  { id: '2', name: "Criterion 1", ranks: 5, minText: "내향적", maxText: "외향적", category: "일반적인 성향" },
  { id: '3', name: " 감성적 vs 이성적", ranks: 5, minText: "감성적", maxText: "이성적", category: "일반적인 성향" },
  { id: '4', name: " 이타주의 vs 개인주의", ranks: 5, minText: "이타주의", maxText: "원칙을 중시", category: "일반적인 성향" },
  { id: '5', name: "눈치를 보는 편 vs 눈치를 안 보는 편", ranks: 5, minText: "원칙을 중시", maxText: "원칙을 중시", category: "일반적인 성향" },
  
  { id: '6', name: " 시간에 둔감 vs 시간 중시", ranks: 5, minText: "원칙을 중시", maxText: "원칙을", category: "업무성향" },
  { id: '7', name: " 의견이 적은 편 vs 의견이 많은 편", ranks: 5, minText: "원칙을 중시", maxText: "원칙을", category: "업무성향" },
  { id: '8', name: "고집이 없는 편 vs 고집이 많은 편", ranks: 5, minText: "원칙을 중시", maxText: "원칙을", category: "업무성향" },
  { id: '9', name: "창의적 vs 경험기반 일처리", ranks: 5, minText: "원칙을 중시", maxText: "원칙을", category: "업무성향" },
  { id: '10', name: "본인의 전문분야에 충실 vs 다방면의 업무지식 풍부", ranks: 5, minText: "본인의 전문분야에", maxText: "다방면의 업무지식 풍부", category: "업무성향" },
  { id: '11', name: "팔로워 vs 리더", ranks: 5, minText: "팔로워", maxText: "리더", category: "업무성향" },
  { id: '12', name: "계획형 vs 행동형", ranks: 5, minText: "계획형", maxText: "행동형", category: "업무성향" },
  { id: '13', name: "시스템 엄수 vs 시스템 개선", ranks: 5, minText: "시스템 엄수", maxText: "시스템 개선", category: "업무성향" },

  { id: '14', name: " 시간에 둔감 vs 시간 중시", ranks: 5, minText: " 완성도가 중요", maxText: "속도가 중요", category: "어떤 상황에서 최고의 성과를 내나요?" },
  { id: '15', name: " 의견이 적은 편 vs 의견이 많은 편", ranks: 5, minText: "소규모 프로젝트", maxText: "대규모 프로젝트", category: "어떤 상황에서 최고의 성과를 내나요?" },
  { id: '16', name: "고집이 없는 편 vs 고집이 많은 편", ranks: 5, minText: ". 체계가 잡힌 환경 ", maxText: "체계가 없는 환경", category: "어떤 상황에서 최고의 성과를 내나요?" },
  { id: '17', name: "창의적 vs 경험기반 일처리", ranks: 5, minText: "솔플레이", maxText: "팀플레이", category: "어떤 상황에서 최고의 성과를 내나요?" },
  { id: '18', name: "본인의 전문분야에 충실 vs 다방면의 업무지식 풍부", ranks: 5, minText: "상주 근무", maxText: "리모트 근무", category: "어떤 상황에서 최고의 성과를 내나요?" },
