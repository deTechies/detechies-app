...
export const Ranking: React.FC<RankingProps> = ({
  ...
  return (
    <div className="grid grid-cols-8 items-center gap-8 text-center">
      <span
        className={`col-span-2 px-4 py-2 text-sm bg-neutral-100 rounded-[4px] inline-flex text-title_s ease-out duration-200  
        ${
