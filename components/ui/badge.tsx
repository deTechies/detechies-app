  ...
  "inline-flex items-center whitespace-nowrap",
  {
    variants: {
      variant: {
        ...
        warning: "border-transparent bg-state-warning-secondary text-state-warning",
        secondary:
      ...
      shape: {
        default: "text-sm font-normal rounded-md border px-3 py-1 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
        category: "testtest py-2 px-2.5 rounded-[5px] bg-background-layer-2 text-title_s",
        outline: "py-2 px-2.5 rounded-md bg-background-transparent ",
      },
    },
    defaultVariants: {
      variant: "default",
